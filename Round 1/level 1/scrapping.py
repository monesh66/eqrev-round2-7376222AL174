...
def openUrl():
    driver_path = os.path.join("driver", "chromedriver.exe")  # Adjust path
    service = Service(driver_path)
    driver = webdriver.Chrome(service=service)
    
    driver.get("https://www.zeptonow.com/brand/Lay%27s/18d6cb72-65aa-4881-8984-a08aa295dd35?s")
    time.sleep(5)
    return driver
...
def scrollToBottom(driver):
    ...
    while True:
        # Scroll down slightly before footer (e.g., 1000px from bottom)
